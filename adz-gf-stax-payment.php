 ...
 * Author URI: https://adzjo.online
 * License: GPL-2.0+
 * License URI: http://www.gnu.org/licenses/gpl-2.0.txt
 * WC requires at least: 3.0.0
 * WC tested up to: 5.9.0
 * Text Domain: adz-gf-stax-payment
 */
...
define('ADZ_STAX_PLUGIN_DIR', plugin_dir_path(__FILE__));
define('ADZ_STAX_PLUGIN_URL', plugin_dir_url(__FILE__));
